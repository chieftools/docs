...
Scopes limit what an access token can do in Tny. Choose them when you create an [access token](/api/tokens#access-tokens). Start with the narrowest scope that covers your integration. The shared [scopes guide](/api/scopes) explains how parent scopes and write access work.
