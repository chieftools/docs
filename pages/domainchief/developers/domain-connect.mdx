...
<Head>
  <title>Domain Connect - Domain Chief</title>
</Head>
...
<Callout type="info" title="Where this shows up">
Products like <ExternalLink href="https://lettermint.co/">Lettermint</ExternalLink> for transactional email delivery and <ExternalLink href="https://cirrux.co/">Cirrux</ExternalLink> for email and workspace hosting are good examples of where Domain Connect is useful. Instead of asking users to manually copy MX, CNAME, TXT, or verification records, these products can guide users through an automated DNS setup flow.
</Callout>
