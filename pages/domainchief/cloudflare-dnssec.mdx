...
<BrowserWindow
  className="my-6"
  url="https://domain.chief.app/team/current/settings"
>
  <img
    className="block w-full rounded-t-none dark:hidden"
    src="/domainchief/cloudflare-dnssec/cloudflare-connect-light.png"
    alt="Cloudflare connection dialog in light mode showing the required token permissions and an empty API token field"
    width="900"
    height="900"
    loading="lazy"
  />
  <img
    ...
    src="/domainchief/cloudflare-dnssec/cloudflare-connect-dark.png"
    alt="Cloudflare connection dialog in dark mode showing the required token permissions and an empty API token field"
    width="900"
    height="900"
    loading="lazy"
  />
