...
API scopes control what actions a token can perform in the Domain Chief API. Scopes are assigned when creating an [Access Token](/accountchief/api/tokens#access-tokens).
For a general overview of how scopes work, see the [scopes documentation](/accountchief/api/scopes) page.
