---
title: Introduction
ogTitle: Integrate with Account Chief
description: Use Account Chief authentication, OAuth, team APIs, scopes, and identity data in a Chief Tools integration.
---
...
Account Chief provides authentication and account context across Chief Tools. It issues API tokens, runs the OAuth 2.0 and OpenID Connect flows, and provides APIs for teams, members, connected applications, invoices, and token metadata.
...
<div className="not-prose my-6 grid gap-4 sm:grid-cols-2">
  ...
  >
    ...
    <p className="mt-1.5 text-sm text-muted-foreground">
      Choose access to team settings, members, applications, invoices, token metadata, and identity details.
    </p>
  </Link>
</div>
...
<div className="not-prose my-6 grid gap-4 sm:grid-cols-2">
  ...
  >
    ...
    <p className="mt-1.5 text-sm text-muted-foreground">
      Explore the schema and send queries from the playground.
    </p>
  </Link>
</div>
...
- [FlowGuard](/developers/flowguard) for request logs, traffic-matching rules, actions, servers, and IP lists.
