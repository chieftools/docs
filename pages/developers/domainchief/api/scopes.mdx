...
The token can read the team event feed and retrieve current domain and contact state. It cannot change those resources. The [event synchronization guide](/developers/domainchief/guides/events) explains the cursor workflow.
