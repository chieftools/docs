...
- Use the [data synchronization workflow](/developers/domainchief/guides/sync-data) to keep domains, contacts, DNS records, web redirects, and mail forwards current.
