...
Scopes define what actions an API token is allowed to perform. When creating an [access token](/api/tokens#access-tokens), you can assign scopes to limit its access to only what is needed.
