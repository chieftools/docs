...
function Header({ navigation }) {
  ...
  return (
    <header
      className={clsx(
        'border-t-4 border-brand sticky top-0 z-50 flex flex-wrap items-center justify-between bg-white px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8',
        isScrolled
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link href="https://github.com/chieftools" className="group" aria-label="GitHub">
